  ...
  cron.schedule(
    ...
    select
      net.http_post(
        ...
        -- ⚠️ 401 Error Fix: নিচের Authorization টোকেনটি পরিবর্তন করুন। 
        -- Supabase Dashboard > Project Settings > API > Project API keys থেকে আপনার anon বা service_role কি (key) কপি করে এখানে দিন।
        headers:='{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im13a29xeHR5eGRra3FsYWtycnZkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NjY3NjM4NywiZXhwIjoyMDgyMjUyMzg3fQ.qlyd2zvoJrQLdj7lbV1Yb3cbIhtgYm8PeDIqfgD25N8"}'
      );
    $$
  );
